...
public class ListCategoryProductAdapter extends SuperAdapter<CategoryProductModel> {
    ...
    public void onBind(SuperViewHolder holder, int viewType, int layoutPosition, final CategoryProductModel item) {
        ...
        if (layoutPosition % 2 == 0) {
            ...
            AppProvider.getImageHelper().displayImage(Consts.HOST_API+item.getCategory_image(),imgCategoryBG1,null,R.drawable.app_logo);
        } else {
            ...
            AppProvider.getImageHelper().displayImage(Consts.HOST_API+item.getCategory_image(),imgCategoryBG2,null,R.drawable.app_logo);
        }
